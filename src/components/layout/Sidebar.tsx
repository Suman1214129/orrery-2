    ...
    <TooltipProvider>
      ...
      <div
        ...
        className={cn(
          ...
          'bg-[var(--bg-subtle)] border-e border-[var(--border)]',
      ...
      >
        <div className="relative flex flex-col h-full max-h-full">
          ...
          <header className="py-4 px-2 flex justify-between items-center gap-x-2">
            ...
            {/* Brand — hidden when minified */}
            <a
              href="/home"
              aria-label="Orrery"
              className={cn(
                'flex items-center gap-2 font-semibold text-xl text-[var(--text)] focus:outline-none focus:opacity-80 flex-none',
                minified && 'lg:hidden',
              )}
            >
            ...
            {minified && (
              <a
                href="/home"
                aria-label="Orrery"
                className="hidden lg:flex w-7 h-7 rounded-md bg-[var(--accent)] items-center justify-center flex-shrink-0 focus:outline-none focus:opacity-80"
              >
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                  <circle cx="12" cy="12" r="3" fill="white" />
                  <circle cx="12" cy="12" r="7" stroke="white" strokeWidth="2" fill="none" opacity="0.6" />
            ...
            <div className="lg:hidden">
              <button
                ...
                className="flex justify-center items-center gap-x-3 size-6 bg-[var(--surface)] border border-[var(--border)] text-sm text-[var(--text-muted)] hover:bg-[var(--bg-muted)] rounded-full disabled:opacity-50 focus:outline-none focus:bg-[var(--bg-muted)]"
          ...
          {/* Nav body */}
          <nav
            className="h-full overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-none [&::-webkit-scrollbar-track]:bg-[var(--bg-muted)] [&::-webkit-scrollbar-thumb]:bg-[var(--border)]"
                  ...
                  return (
                    <li key={href}>
                      <button
                        ...
                        className={cn(
                          'min-h-[36px] w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-lg transition-colors focus:outline-none',
                          active
                            ? 'bg-[var(--bg-muted)] text-[var(--text)] font-medium'
                            : 'text-[var(--text-muted)] hover:bg-[var(--bg-muted)] hover:text-[var(--text)] focus:bg-[var(--bg-muted)]',
                          minified && 'lg:justify-center',
                        )}
                      >
                        <Icon size={16} className="shrink-0 size-4" />
                        <span className={cn('text-nowrap', minified && 'lg:hidden')}>{label}</span>
                      </button>
                    </li>
                  )
                })}
          ...
          <div className="border-t border-[var(--border)] p-2 flex items-center gap-1">
            <button
              ...
              className={cn(
                'flex items-center gap-2 flex-1 min-w-0 rounded-lg px-2 py-1.5 hover:bg-[var(--bg-muted)] transition-colors focus:outline-none focus:bg-[var(--bg-muted)]',
            ...
            >
              ...
              <span className={cn('text-sm text-[var(--text-muted)] truncate', minified && 'lg:hidden')}>
                {displayName}
              </span>
            </button>
              ...
              <>
                <Tooltip content={isDark ? 'Light mode' : 'Dark mode'}>
                  <button
                    ...
                    className="flex justify-center items-center size-8 text-[var(--text-muted)] hover:bg-[var(--bg-muted)] rounded-lg focus:outline-none transition-colors"
